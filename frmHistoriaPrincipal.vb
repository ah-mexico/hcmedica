...
#End Region
    ...
    Private Sub frmHistoriaPrincipal_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'Fija el punto como separador decimal para la aplicación.
        ...
        Else
            ...
            'strArgumentos = "<?xml version=" & Chr(34) & "1.0" & Chr(34) & " encoding=" & Chr(34) & "ISO-8859-1" & Chr(34) & " ?><Raiz><Row Servidor=" & Chr(34) & "pruebasdesa" & Chr(34) & " BaseDatos=" & Chr(34) & "sophia" & Chr(34) & " UserID=" & Chr(34) & "sophia" & Chr(34) & " PWD=" & Chr(34) & "sophia" & Chr(34) & " Prestadora=" & Chr(34) & "1100109887" & Chr(34) & " des_prestadora=" & Chr(34) & "CLINICA COLSANITAS" & Chr(34) & " Sucursal=" & Chr(34) & "0003" & Chr(34) & " des_Sucursal=" & Chr(34) & "CLINICA REINA SOFIA" & Chr(34) & " Login=" & Chr(34) & "MED" & Chr(34) & " TipoUsuario=" & Chr(34) & "M" & Chr(34) & " medico=" & Chr(34) & "MED" & Chr(34) & " nom_medico=" & Chr(34) & "Ricardo Mauricio Zaldúa C." & Chr(34) & " especialidad=" & Chr(34) & "341" & Chr(34) & " des_especialidad=" & Chr(34) & Chr(34) & " reg_medico=" & Chr(34) & Chr(34) & " cen_costo=" & Chr(34) & "0023" & Chr(34) & " ciudad=" & Chr(34) & "001" & Chr(34) & " des_ciudad=" & Chr(34) & Chr(34) & " depart=" & Chr(34) & "11" & Chr(34) & " des_depart=" & Chr(34) & Chr(34) & " pais=" & Chr(34) & "480" & Chr(34) & " des_pais=" & Chr(34) & Chr(34) & " contingencia=" & Chr(34) & "S" & Chr(34) & " man_rips=" & Chr(34) & "S" & Chr(34) & " Corregir=" & Chr(34) & "N" & Chr(34) & "/></Raiz>"
            'strArgumentos = "<?xml version=" & Chr(34) & "1.0" & Chr(34) & " encoding=" & Chr(34) & "ISO-8859-1" & Chr(34) & " ?><Raiz><Row Servidor=" & Chr(34) & "pruebasdesa" & Chr(34) & " BaseDatos=" & Chr(34) & "sophia" & Chr(34) & " UserID=" & Chr(34) & "sophia" & Chr(34) & " PWD=" & Chr(34) & "sophia" & Chr(34) & " Prestadora=" & Chr(34) & "1100109887" & Chr(34) & " des_prestadora=" & Chr(34) & "CLINICA COLSANITAS" & Chr(34) & " Sucursal=" & Chr(34) & "0139" & Chr(34) & " des_Sucursal=" & Chr(34) & "CLINICA REINA SOFIA" & Chr(34) & " Login=" & Chr(34) & "52409720" & Chr(34) & " TipoUsuario=" & Chr(34) & "M" & Chr(34) & " medico=" & Chr(34) & "52409720" & Chr(34) & " nom_medico=" & Chr(34) & "Ricardo Mauricio Zaldúa C." & Chr(34) & " especialidad=" & Chr(34) & "385" & Chr(34) & " des_especialidad=" & Chr(34) & Chr(34) & " reg_medico=" & Chr(34) & Chr(34) & " cen_costo=" & Chr(34) & "0023" & Chr(34) & " ciudad=" & Chr(34) & "001" & Chr(34) & " des_ciudad=" & Chr(34) & Chr(34) & " depart=" & Chr(34) & "11" & Chr(34) & " des_depart=" & Chr(34) & Chr(34) & " pais=" & Chr(34) & "480" & Chr(34) & " des_pais=" & Chr(34) & Chr(34) & " contingencia=" & Chr(34) & "S" & Chr(34) & " man_rips=" & Chr(34) & "S" & Chr(34) & " Corregir=" & Chr(34) & "N" & Chr(34) & "/></Raiz>"
            ...
            'Pre-producción Conciliación medicamentos            
            ...
            'Desarrollo Conciliación medicamentos            
            ...
            'MsgBox("No existen parámetros de entrada", MsgBoxStyle.Information)
            'Me.Close()
            'Exit Sub
            '#End If
        ...
        'Label2.Text = "Versión " & objDatosGenerales.Version
        ...
        'Label2.Text = "Versión Beta: " & version.ToString() '& buildDate.ToString()
        Label2.Text = "Versión: " & version.ToString() '& buildDate.ToString()

        strDescripcion = ""
        intVersion = TraerVersion("EXHIS", strDescripcion)
        'intVersion = 2100
        If intVersion > CInt(Replace(version.ToString(), ".", "")) Then
            MsgBox("La versión de " & UCase(strDescripcion) & " se encuentra desactualizada." & vbCr & vbCr & "El equipo debe tener instalada la versión " & intVersion &
            vbCr & vbCr & "Para poder ingresar apague y vuelva a prender el equipo. " & vbCr & vbCr & "Si el problema continua despues de reiniciar comuniquese con el MAS a la extensión 5711000 ", vbCritical)

            '2019-03-11 Inicio. Se direcciona el reporte al Servidor De Reporte Consolidado
            'Juan Carlos Jaramillo Lozano - IG
            RptHC_Enf_Med.RptHC_Enf_Med_FormEstado(objConexion, "1", "C", "La versión de " & UCase(strDescripcion) & " se encuentra desactualizada. El equipo debe tener instalada la versión " & intVersion &
            " Para poder ingresar apague y vuelva a prender el equipo.  Si el problema continua despues de reiniciar comuniquese con el MAS a la extensión 5711000 ")
            '2019-03-11 Fin
        ...
        If objDatosGenerales.TipoUsuario <> TIPOUSUARIO_MEDICO Then
            ...
            If objDatosGenerales.SoloConsulta = False And objDatosGenerales.SoloConsultaFarma = False Then
                MsgBox("Usuario no autorizado para esta opción.", MsgBoxStyle.Information)

                '2019-03-11 Inicio. Se direcciona el reporte al Servidor De Reporte Consolidado
                'Juan Carlos Jaramillo Lozano - IG
                RptHC_Enf_Med.RptHC_Enf_Med_FormEstado(objConexion, "1", "C", "Usuario no autorizado para esta opción.")
                '2019-03-11 Fin
...
Salir:
    ...
    Private Sub ValidaPerfilusuario()
        ''Se valida si el perfil del usuario es solo con opción de consulta cpgaray Octubre 2 de 2013
    ...
    Private Sub cmdHistoriaBasica_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdHistoriaBasica.Click
        ...
        If Not ctlOrdMedicas Is Nothing Then
            If ctlOrdMedicas.existenDatosSinAlmacenar() Then
                ...
                End If
                Select Case MessageBox.Show("No se ha guardado la información registrada, perderá los cambios realizados ¿desea continuar?", "Historia Clinica", MessageBoxButtons.OKCancel, MessageBoxIcon.Question)
    ...
    Public Sub IniciaHistoriaBasica()
        ...
        'se elimina validación a solicitud del requerimiento ER_OSI_602
        '
    ...
    Private Sub frmHistoriaPrincipal_FormClosing(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles Me.FormClosing
        ...
        If Not ctlPantallaProcedimExt Is Nothing Then
            If ctlPantallaProcedimExt.existenDatosSinAlmacenar() Then
                ...
                Select Case MessageBox.Show("Existe información sin Guardar correspondiente a los procedimientos registrados. Desea almacenar esta información?", "Historia Clinica", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case Windows.Forms.DialogResult.Yes
                        ''se almacenan los datos
                        ctlPantallaProcedimExt.guardarDatosGrid()
                    Case Windows.Forms.DialogResult.No
                        'La información registrada en esta pantalla  que no ha sido guardada se perderá definitivamente
                        Select Case MessageBox.Show("La información registrada en esta pantalla  que no ha sido guardada se perderá definitivamente.", "Historia Clinica", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning)
                            Case Windows.Forms.DialogResult.OK
                                'Exit Sub
                            Case Windows.Forms.DialogResult.Cancel
                                e.Cancel = True
        ...
        If Not ctlOrdMedicas Is Nothing Then
            If ctlOrdMedicas.existenDatosSinAlmacenar() Then
                ...
                Select Case MessageBox.Show("Existe información sin Guardar correspondiente a Ordenes médicas. Desea almacenar esta información?", "Historia Clinica", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
                    Case Windows.Forms.DialogResult.Yes
            ...
            If Not IsDBNull(strResidente) Then
                If strResidente <> "" Then
                    If strResidente = "S" Then
                        If MsgBox("La asistencia del paciente la realizo en compañía de su instructor", MsgBoxStyle.YesNo) = MsgBoxResult.Yes Then
                            frmConsulta.ShowDialog()
                            If frmConsulta.ValidaSeleccion = 0 Then
                                Return False
                            End If
                        Else
                            lErrorR = objDaoBasica.AlmacenaMedicoResidente(objConexion, objDatosGenerales.Prestador, objDatosGenerales.Sucursal, Paciente.Instancia.TipoAdmision, Paciente.Instancia.AnoAdmision, Paciente.Instancia.NumeroAdmision, Paciente.Instancia.TipoDocumento, Paciente.Instancia.NumeroDocumento, "", objDatosGenerales.Login, objDatosGenerales.Login, "Sin Medico Acompañante")
                            If lErrorR <> 0 Then
            ...
            Case BLEgresos.OpcionSalida.Observacion
                Try
                    If estadoHistoria <> Paciente.OBSERVACION And estadoHistoria <> "" Then
                        ...
                        If lError <> 0 Then
                            MsgBox("Se ha presentado un error en el proceso de grabacion al dejar en observación la historia clinica.", MsgBoxStyle.Exclamation)
                        End If
                    End If
                Catch ex As Exception
                    MsgBox("Se ha presentado un error en el proceso de grabacion al dejar en observación la historia clinica. " & Err.Number, MsgBoxStyle.Exclamation)
                End Try
    ...
    Private Sub reimprimirOrdenMedica(ByVal tip_admision As String, ByVal ano_adm As String, ByVal num_adm As String)
        ...
        Dim objPaciente As Paciente
        objPaciente = Paciente.Instancia()
        strNroOrden = InputBox("Digite el número de orden médica", "Reimpresión de Ordenes Médicas")

        If strNroOrden.Trim.Length <= 0 Then
            MsgBox("Debe digitar el número de orden médica. ")
            Exit Sub
        ElseIf Not IsNumeric(strNroOrden) Then
            MsgBox("Debe digitar datos numéricos. ")
            Exit Sub
        End If
    ...
    Private Sub reimprimirOrdenMedicaControl(ByVal tip_admision As String, ByVal ano_adm As String, ByVal num_adm As String)
        ...
        strNroOrden = InputBox("Digite el número de orden médica de control", "Reimpresión de Ordenes Médicas de control")

        If strNroOrden.Trim.Length <= 0 Then
            MsgBox("Debe digitar el número de orden médica de control. ")
            Exit Sub
        ElseIf Not IsNumeric(strNroOrden) Then
            MsgBox("Debe digitar datos numéricos. ")
            Exit Sub
    ...
    Private Sub reimprimirProcedimientosExternos(ByVal tip_admision As String, ByVal ano_adm As String,
        ...
        strNroOrden = InputBox("Digite el número de formula de procedimientos. ", "Reimpresión de Procedimientos Externos")

        If strNroOrden.Trim.Length <= 0 Then
            MsgBox("Debe digitar el número de formula de procedimientos. ")
            Exit Sub
        ElseIf Not IsNumeric(strNroOrden) Then
            MsgBox("Debe digitar datos numéricos. ")
            Exit Sub
    ...
    Private Sub reimprimirFormulacionExterna(ByVal tip_admision As String, ByVal ano_adm As String,
        ...
        strNroOrden = InputBox("Digite el número de formula médica. ", "Reimpresión de Formulación Externa")

        If strNroOrden.Trim.Length <= 0 Then
            MsgBox("Debe digitar el número de formula médica. ")
            Exit Sub
        ElseIf Not IsNumeric(strNroOrden) Then
            MsgBox("Debe digitar datos numéricos. ")
            Exit Sub
    ...
    '            If MessageBox.Show("Desea Guardar la información de los procedimientos registrados?", "Historia Clinica", MessageBoxButtons.YesNo, MessageBoxIcon.Question) = Windows.Forms.DialogResult.Yes Then
    ...
    Private Sub btn360Layout_Click(sender As Object, e As EventArgs) Handles btn360Layout.Click
        ...
        Try
            ...
            '    If MessageBox.Show("No se logró generar la auditoria, desea continuar?", "Paciente 360") = DialogResult.Cancel Then
            '        Exit Sub
            '    End If
            'Else
    ...
    Private Function ValidarFinalizarHcb() As Boolean
        ...
        Try
            'Control de cambios CU ELIMINAR RESTRICCIÓN HISTORIA BASICA

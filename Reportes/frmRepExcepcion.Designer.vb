...
Partial Class frmRepExcepcion
    ...
    Private Sub InitializeComponent()
        ...
        ReportDataSource1.Name = "HistoriaClinica_Sophia_HistoriaClinica_Reportes_Nota"
        ReportDataSource1.Value = Me.NotaBindingSource
        Me.ReportViewer1.LocalReport.DataSources.Add(ReportDataSource1)
        Me.ReportViewer1.LocalReport.ReportEmbeddedResource = "HistoriaClinica.RepExcepcion.rdlc"
        ...
        'NotaBindingSource
        '
        Me.NotaBindingSource.DataSource = GetType(HistoriaClinica.Sophia.HistoriaClinica.Reportes.Nota)
        '
        'frmRepExcepcion
        '

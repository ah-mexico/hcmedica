...
Namespace Sophia.HistoriaClinica.Reportes
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class EvolucionInterconsulta
...
#End Region
        ...
        Public Sub New(ByVal strfecha As String, ByVal strhora As String, ByVal strminuto As String, _
                ...
                ByVal strNotaIngreso As String, ByVal strexp_pla As String, ByVal strcon_med As String, ByVal strinterconsulta As String, ByVal strespecialidad As String)
            Dim fecha As Date
            If strinterconsulta.Length > 0 Then
        ...
        Public Function consultarEvolucion(ByVal objConexion As Conexion, ByVal strcod_pre_sgs As String, _
                          ...
                          Optional ByVal fec_fin As String = "") As List(Of EvolucionInterconsulta)
            ...
            Dim objEvolucion As EvolucionInterconsulta
            Dim listaEvoluciones As New List(Of EvolucionInterconsulta)
            ...
            While dtReader.Read()
                If Len(dtReader("interconsulta").ToString) > 0 And dtReader("interconsulta").ToString <> "N" Then 'martovar 2014-09-19 version 2.9.0 muestra las interconsultas
                    strRegMedico = ""
                    ...
                    objEvolucion = New EvolucionInterconsulta(dtReader("fecha_evol").ToString, _
                                                  ...
                                                  dtReader("exp_pla").ToString, dtReader("con_med").ToString, dtReader("interconsulta").ToString, dtReader("especialidad").ToString) ''cpgaray OS 7509755

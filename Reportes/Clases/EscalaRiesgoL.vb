...
Namespace Sophia.HistoriaClinica.Reportes
    ...
    Public Class EscalaRiesgoL
        ...
        Public Sub New(ByVal scod As String, ByVal sconsecutivo As String, ByVal dfecha As String, ByVal sDescr As String, ByVal smedico As String, ByVal scargo As String, ByVal Itotal As String, ByVal hora As String, ByVal minuto As String, ByVal categoria_riesgo As String)
        ...
        Public Function consultarEscalaRiesgo(ByVal objConexion As Conexion, ByVal dCod_Historia As Integer, ByVal strFechaIni As Nullable(Of Date), ByVal strFechaFin As Nullable(Of Date), ByVal iHoraIni As Nullable(Of Integer), ByVal iHoraFin As Nullable(Of Integer), ByVal IdEscala As Integer) As List(Of EscalaRiesgoL)
            ...
            For i As Integer = 0 To dtSetReturn.Tables(0).Rows.Count.ToString() - 1
                objEscalaRiesgoN = New EscalaRiesgoL
        ...
        Public Function consultarEscalaRiesgo1(ByVal objConexion As Conexion, ByVal dCod_Historia As Integer, ByVal strFechaIni As Nullable(Of Date), ByVal strFechaFin As Nullable(Of Date), ByVal iHoraIni As Nullable(Of Integer), ByVal iHoraFin As Nullable(Of Integer), ByRef listaEscalaRiesgo As List(Of EscalaRiesgo1)) As List(Of EscalaRiesgoL)
            Dim lError As Long = 0
            Dim objEscalaRiesgoN As EscalaRiesgoL
            Dim listaEscala As New List(Of EscalaRiesgoL)
            Dim dtSetReturn As DataSet
            ...
            listaEscalaRiesgo = EscalaRiesgo1.crearListaRiesgo(dtSetReturn.Tables(0))


            For i As Integer = 0 To dtSetReturn.Tables(1).Rows.Count.ToString() - 1
                objEscalaRiesgoN = New EscalaRiesgoL
                With objEscalaRiesgoN
                    ._cod_historia = dtSetReturn.Tables(1).Rows(i).Item("cod_historia").ToString()
                    ._consecutivo = dtSetReturn.Tables(1).Rows(i).Item("consecutivo").ToString

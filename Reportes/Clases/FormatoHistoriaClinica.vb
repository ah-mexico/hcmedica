...
#End Region
        ...
        Public Sub consultarHistoriaClinica(ByVal objConexion As Conexion, ByVal strcod_pre_sgs As String,
            ...
            'vi.	Traumatológicos = New Inmunologico().consultarAntInmunologico(objConexion, strcod_pre_sgs, strCod_sucur, strTipDoc, strNumDoc, strLogin, _encabezado.FechaConFormato, "", "", "", fec_ini, fec_fin) 'aasanabria 2012/07/18 fec_ini, fec_fin

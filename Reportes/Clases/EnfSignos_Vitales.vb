...
Namespace Sophia.HistoriaClinica.Reportes
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class EnfSignos_Vitales
        ...
        Private _temperatura As Long
        Private _obs_sigv As String
...
#End Region
        ...
        Public Sub New(ByVal intCod_Historia As Integer, ByVal intConsecutivo As Integer, ByVal strdesc_tipocateter As String, ByVal fdtfecha As DateTime, _
                       ...
                       ByVal strdesc_indicacion As String, ByVal strfre_cardiaca As Integer, ByVal strfre_respira As Integer, ByVal strtemperatura As Long, ByVal strobs_sigv As String)
            ...
            _fre_cardiaca = strfre_cardiaca
            _fre_respira = strfre_respira
            _temperatura = strtemperatura
            _obs_sigv = strobs_sigv
        End Sub
        Public Function consultarSignosVitales(ByVal objConexion As Conexion, ByVal dCod_Historia As Long, ByVal strFechaIni As Nullable(Of Date), ByVal strFechaFin As Nullable(Of Date), ByVal iHoraIni As Nullable(Of Integer), ByVal iHoraFin As Nullable(Of Integer)) As DataTable

            Dim lError As Long = 0
            gpmDataObj.setSQLSentence("HCENF_ReporteSignosVitales", CommandType.StoredProcedure)

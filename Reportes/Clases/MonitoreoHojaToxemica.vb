...
Namespace Sophia.HistoriaClinica.Reportes
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class MonitoreoHojaToxemica
...
#End Region
        ...
        Public Function consultarMonitoreoHojaToxemica(ByVal objConexion As Conexion, ByVal dCod_Historia As Integer, ByVal strFechaIni As Nullable(Of Date), ByVal strFechaFin As Nullable(Of Date), ByVal iHoraIni As Nullable(Of Integer), ByVal iHoraFin As Nullable(Of Integer)) As DataTable
            Dim lError As Long = 0
            gpmDataObj.setSQLSentence("HENF_ReporteHojaToxemica", CommandType.StoredProcedure)

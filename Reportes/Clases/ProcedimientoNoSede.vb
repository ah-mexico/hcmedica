...
' Se crea esta clase para los procedimientos que no se realizan en la sede
...
Namespace Sophia.HistoriaClinica.Reportes
    Public Class ProcedimientoNoSede
...
#End Region
        ...
        Public Function consultarProcedimientos(ByVal objConexion As Conexion, ByVal strcod_pre_sgs As String, _
                   ...
                   ByVal iano_adm As Long, ByVal lnum_adm As Double) As List(Of ProcedimientoNoSede)
            ...
            Dim objProcedimiento As ProcedimientoNoSede
            Dim drDatos As IDataReader
            Dim listaProcedimiento As New List(Of ProcedimientoNoSede)
            ...
            While drDatos.Read()
                objProcedimiento = New ProcedimientoNoSede(drDatos("procedim").ToString, drDatos("bDescripcion").ToString, _
        ...
        Public Function consultarProcedimientosNoSede(ByVal objConexion As Conexion, ByVal strcod_pre_sgs As String, _
                   ByVal strCod_sucur As String, ByVal strTip_admision As String, _
                   ByVal iano_adm As Long, ByVal lnum_adm As Double) As List(Of ProcedimientoNoSede)
            ...
            Dim objProcedimiento As ProcedimientoNoSede
            Dim drDatos As IDataReader
            Dim listaProcedimientoNoSede As New List(Of ProcedimientoNoSede)
            ...
            While drDatos.Read()
                ...
                objProcedimiento._numeroOrden = drDatos("con_procedim").ToString
                listaProcedimientoNoSede.Add(objProcedimiento)
            End While
            ...
            Return listaProcedimientoNoSede

        End Function

        Public Function crearListaProcedimQuirurgicos(ByVal drDatos As IDataReader) As List(Of ProcedimientoNoSede)
            ...
            Try
                While drDatos.Read()
                    ...
                    objProcedimiento = New ProcedimientoNoSede(drDatos("procedim").ToString, drDatos("Descripcion").ToString, "", "", 0, _
        ...
        'Public Function crearListaProcedimOrdenMedica(ByVal dtProcedim As DataTable, Optional ByVal strPracticaosi As String = "") As List(Of ProcedimientoNoSede)
        '    Dim lista As New List(Of ProcedimientoNoSede)
        '    Dim objProcedimiento As ProcedimientoNoSede
        '    Dim i As Integer
        ...
        '        objProcedimiento = New ProcedimientoNoSede()
        ...
        Public Function crearListaProcedimOrdenMedicaNoSede(ByVal dtProcedim As DataTable, ByVal NombreMedico As String, _
        ByVal RegistroMedico As String, ByVal DescripcionEspecialidad As String) As List(Of ProcedimientoNoSede)
            Dim lista As New List(Of ProcedimientoNoSede)
            Dim objProcedimiento As ProcedimientoNoSede
            Dim i As Integer
            ...
            ' herojas agfa_orm_in 2014/09/23
            rowsProcedimientos = dtProcedim.Select("numconsulta=4") ' La consulta 4 devuelve los procedimientos que no se realizan en la sede de la orden

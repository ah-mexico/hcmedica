...
Namespace Sophia.HistoriaClinica.Reportes
    ...
    ''' </summary>
    ''' <remarks></remarks>
    Public Class PlaneacionCuidado
...
#End Region
        ...
        Public Function consultarPlaneacionCuidados(ByVal objConexion As Conexion, ByVal dCod_Historia As Decimal, ByVal strFechaIni_RecNac As String, ByVal strFechaFin_RecNac As String, ByVal iHoraIni_RecNac As Integer, ByVal iHoraFin_RecNac As Integer) As List(Of Planeacion)
        ...
        Public Function consultarPlaneacionDT(ByVal objConexion As Conexion, ByVal dCod_Historia As Integer, ByVal strFechaIni_RecNac As Nullable(Of DateTime), ByVal strFechaFin_RecNac As Nullable(Of DateTime), ByVal iHoraIni_RecNac As Nullable(Of Integer), ByVal iHoraFin_RecNac As Nullable(Of Integer)) As List(Of PlaneacionCuidado)
            ...
            For Each drFila In dtReader.Rows
                objPlaneacion = New PlaneacionCuidado
                With objPlaneacion

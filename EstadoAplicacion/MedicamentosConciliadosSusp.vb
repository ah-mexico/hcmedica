Public Class MedicamentosConciliadosSusp
    Implements IDisposable

    Private Shared _instancia As MedicamentosConciliadosSusp
    ...
    Public Shared ReadOnly Property Instancia() As MedicamentosConciliadosSusp
        Get
            If _instancia Is Nothing Then
                _instancia = New MedicamentosConciliadosSusp()
            End If
            Return _instancia
        End Get
    End Property

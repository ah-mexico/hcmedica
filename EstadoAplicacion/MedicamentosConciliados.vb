Public Class MedicamentosConciliados
    Implements IDisposable

    Private Shared _instancia As MedicamentosConciliados
    ...
    Public Shared ReadOnly Property Instancia() As MedicamentosConciliados
        Get
            If _instancia Is Nothing Then
                _instancia = New MedicamentosConciliados()
            End If
            Return _instancia
        End Get
    End Property

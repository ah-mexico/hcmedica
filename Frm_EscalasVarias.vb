...
Public Class Frm_EscalasVarias
    ...
    Private Sub Frm_EscalasVarias_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Function ValidaEscalasLink(IdEscalaSeleccionada As Int16) As String
        Dim mensaje As String = Nothing
        datosLogin = Generales.Instancia()
        datosPaciente = Paciente.Instancia()
        datosconexion = Conexion.Instancia()
        _IdEscala = IdEscalaSeleccionada
        mensaje = ValidacionAlCargar(IdEscalaSeleccionada)
        Return mensaje
    End Function
    Public Sub Mostrar(ByVal idescala As Int16)
        Dim mensaje As String = Nothing
        ...
        _IdEscala = idescala
        mensaje = ValidacionAlCargar(idescala)
...
#Region "Impresión"
    Private Sub btImprimirRiesgo_Click(sender As Object, e As EventArgs) Handles btImprimirRiesgo.Click
        ...
        Try
            ...
            '                                 objPaciente.TipoDocumento, objPaciente.NumeroDocumento, datosLogin.NombreMedico, _IdEscala,
            '                                 Now, Now)
